...
framework in ~\citep{skelton2019}, emphasizes that organizations should design both their
...
This is where Hypotheses Engineering may be used to play a key role in the architecture work, as proposed in the ArchHypo account \citep{silva2024tse}.
...
The ArchHypo technique, proposed in ~\citep{silva2024tse}, operationalized this idea for
...
\begin{itemize}
  ...
  The distinguishing feature is the epistemic gap, not the probability of an outcome as observed in ~\citep{silva2024tse}.
...
assessments are made independently and relatively, not on absolute probability as reported in ~\citep{silva2024tse}.
...
deferred. ArchHypo identifies the following plan strategies as observed in ~\citep{silva2024ieeesw}:
...
\begin{itemize}
  ...
  normal work. This was the most frequently used strategy in the evaluation reported in~\citep{silva2024tse}.
...
IEEE Software article in ~\citep{silva2024ieeesw}. The setting was Catch
