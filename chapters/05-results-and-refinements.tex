...
H05 & Credit-bureau service decomposition & Product  & Sol. & H  & VH \\
...
multiple domain contexts, but the boundaries of the service decomposition and the migration path are unknown.

\textbf{Problem:} Deciding \textit{whether} to pursue service decomposition is itself uncertain: the
...
impact on other teams would be. Committing to a decomposition without this information
...
B2 & Structural archetype & Regulatory Trigger Hypothesis
   & External compliance obligation surfaces as tracked architectural
     uncertainty
   & H03, H04 \\
B3 & Structural archetype & Service Decomposition Hypothesis
   & Uncertainty about whether and how to decompose a tightly coupled service
...
service decomposition, and multi-dimensional platform concerns, which are categories the
