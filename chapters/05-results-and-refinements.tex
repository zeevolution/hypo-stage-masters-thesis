...
organisation of the chapter legible relative to those questions.

\subsection{Correspondence between research questions and chapter sections}

Table~\ref{tab:rq-chapter-map} summarises where each research question is principally
...
\caption{Correspondence between the research questions (Chapter~\ref{chap:introduction})
  and the organisation of evidence in this chapter.}
...
\midrule
RQ2 & Section~\ref{sec:rq2-results} (typological account of the corpus). &
...
Section~\ref{sec:rq2-results} discharges the former by characterising what was
registered; Section~\ref{sec:group-b-patterns} discharges the latter by articulating
recurrent structural forms in the corpus. Jointly, they satisfy the formulation of
...
in design-science accounts of artefact evolution, that is, as outcomes grounded in
