...
As stated in Chapter~\ref{chap:introduction}, RQ3 asks: \textit{``What types and
recurring structural shapes of architectural uncertainties do these teams identify,
record, and manage using Hypo-Stage, and what patterns emerge from their content and
organisational context?''}
Section~\ref{sec:rq3-results} addresses the typological part of this question,
characterising uncertainty by source, quality attribute, and lifecycle.
The Group~B patterns in Section~\ref{sec:group-b-patterns} address the second part:
they articulate the \textit{recurring structural shapes} that hypotheses take in
practice and how those shapes carry implications for how hypotheses should be
written and managed---a contribution that goes beyond cataloguing observed instances.
Together, these elements answer RQ3 at the level envisaged when the question was
refined to make the Group~B pattern contribution explicit at the research-question
level rather than treating it only as a supplementary finding.
