...
ratings, entity links, and author notes) appear in Appendix~\ref{app:hypotheses-corpus}. Each hypothesis is identified by a
...
Table~\ref{tab:plan-strategies} summarises
the strategies used.
