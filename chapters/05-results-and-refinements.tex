...
\paragraph{On RQ2 and the emerging patterns.}

As stated in Chapter~\ref{chap:introduction}, RQ2 asks: \textit{``What types and
...
Section~\ref{sec:rq2-results} addresses the typological part of this question,
...
Together, these elements answer RQ2 at the level envisaged when the question was
...
\paragraph{On RQ1, RQ3, and RQ4.}

The four Group~A patterns (Section~\ref{sec:group-a-patterns}) emerge from the
intersection of RQ1 and RQ3 findings: they describe the organisational conditions
...
in practice) and RQ3 (perceived benefits and challenges) and do not require
reformulation of those questions. RQ4 is fully addressed by the nine categories
of Hypo-Stage refinements documented in Section~\ref{sec:rq4-results}, each
