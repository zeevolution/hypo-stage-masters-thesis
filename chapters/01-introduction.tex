...
of software-intensive systems. As first conceived by \citet{perryWolf1992}, the SA
concept structures a system into elements and relations that form the basis of
its organization, conveying coherence, scalability, and maintainability for the
evolving software over time. Despite the ever-changing practices of modern
software development, SA still provides the basis for analyzing the quality
attributes of contemporary systems, guiding technical decisions made throughout
the development process via a diverse set of architectural methodologies, as
systematically mapped by \citet{souza2019}. In organizations that rely on
software as a core part of their business, architecture is not a one-time design
artifact but a continuous decision-making process that must accommodate changing
...
In such environments, architecture decisions are frequently made under uncertainty: solutions or requirements may be incomplete or unstable, the impact of technology choices may not be fully understood, and the behavior of the system under realistic workloads may only become visible after deployment \cite{silva2024tse}. Despite this, architectural uncertainties often remain implicit and unmanaged, and decisions tend to rely on the tacit knowledge and intuition of a small group of experienced architects as observed by \cite{souza2019}.
...
These findings resonate with the observations from ArchHypo studies: while the technique provides a structured way to make architectural uncertainties explicit and to plan actions, applying it in practice is highly demanding without adequate supporting tool.
...
Hypo-Stage when working on their products and services. By forging this path,
this work seeks to gain an understanding of what architectural uncertainties
teams manage through such a tool, and which aspects of Hypo-Stage and its
integration into the development process still require refinement.
...
The study yields three families of concrete results.
First, hypothesis registration proved consistently senior-led in both teams:
twelve of the thirteen hypotheses were authored by staff or principal engineers,
...
the five Group~B archetypes (\textit{Regulatory Trigger Hypothesis} and
...
assessment changes over time --- each directly traceable to a specific observation
and a code commit, making the formative evaluation contribution auditable.
These findings are previewed here to orient the reader; full analysis and
