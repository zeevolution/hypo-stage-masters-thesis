...
table in Section~\ref{sec:app-hypothesis-registers} lists \emph{anonymized} entity
...
The bold header on each register repeats the hypothesis identifier and short label
