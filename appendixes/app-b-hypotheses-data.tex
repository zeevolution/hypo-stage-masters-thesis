...
% ── H05 ─────────────────────────────────────────────────────
\hypoboxnine%
  {H05 --- Credit-bureau decoupling joint}%
  {Product}%
  {2026-03-18}%
  {In Review}%
  {Solution}%
...
%% ─── H05 plan ─────────────────────────────────────────────
\paragraph{TP-05-A \textnormal{(H05 — Credit-bureau decoupling joint)}}
...
\textit{Expected outcome:} A prioritized integration decoupling plan and a
